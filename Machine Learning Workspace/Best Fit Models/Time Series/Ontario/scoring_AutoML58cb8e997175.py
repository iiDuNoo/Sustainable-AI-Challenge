...
input_sample = pd.DataFrame({'Full Date': pd.Series(['2003-05-01T00:00:00.000Z'], dtype='datetime64[ns]'), 'Toronto Weather (deg C)': pd.Series(['7.2'], dtype='float64'), 'HOEP': pd.Series(['27.85'], dtype='float64')})
...
def init():
    ...
    model_path = Model.get_model_path(model_name = 'AutoML58cb8e997175')
